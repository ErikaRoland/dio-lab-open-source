...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/ErikaRoland`;
    > Exemplo: `git checkout -b feat/community/ErikaRoland`
